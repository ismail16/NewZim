...
@section('title')
    Aim and Scope | Sapporo Medical Journal 
@endsection
@section('content')
    <section class="" style="background-color: #7bb2c5;">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card" style="border-radius: 0px;">
                        {{--                        <h6 class="card-header" style="background-color: #04386b; color:#fff;"><i class="fas fa-book"></i> Journals</h6>--}}
                        <div class="card-body" style="_box-shadow: 0px 2px 5px 5px rgb(49, 94, 138);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="card _border-dark-golden-rod rounded-0" style="border: 1px solid #04386b;">
                                                    <h5 class="card-header deep-orange-500 border-top-2 _border-dark-golden-rod rounded-0 fweight-600" >Aim and Scope</h5>
                                                    <div class="card-body row equal-height" style="min-height: 10rem;">
                                                        <div class="col-md-12">
                                                            <h5>Aim-</h5>
                                                            <p class="text-justify ml-3">
                                                                Sapporo Medical Journal (JHMJ) (ISSN:0021-7263) (Nlmid:0072456) is an international open-access
                                                                journal publishes twelve times each year. JHMJ is a peer-reviewed, monthly,
                                                                ...
                                                                of M.B.B.S, M.D., D.T.C.D., GYNE., M.S., M.Pharma, And PhD are requested to send their original research articles to JHMJ.
                                                            </p>
                                                            <h5 id="scopes">Scope-</h5>
                                                            <p class="text-justify ml-3">
                                                                Sapporo Medical Journal (JHMJ) (ISSN:0021-7263) (Nlmid:0072456) is a peer-reviewed journal. The journal seeks to
