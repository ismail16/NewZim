      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                Sub: Sorry! Your Paper has been Rejected.</b>
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                <h4>Dear Dr. {{$user->firstname}},</h4>
                <p>Greetings from "<b>Sapporo Medical Journal</b>". We are very sorry to say that your paper "<b>{{$submit->ptitle}}</b>" has been rejected from the editorial panel in the upcoming issue.<br>We hope this will not discourage you to publish with us in future. Thank you for your interest.</p>
                <h4 style="margin-bottom: 5px;">Thank you,</h4>
                <p>Admin Board</p>
                <p>Sapporo Medical Journal</p>
              </td>
            </tr>
          </table>
        </td>
