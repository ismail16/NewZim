          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="bodycopy">
                ...
                <p>
                    <b style="color: green">Congratulation </b> Your paper has been published!<br>
                    We are very pleased to inform you that your Paper ID: "<b>{{$submit->paper_id}}</b>", Paper Title: "<b>{{$submit->ptitle}}</b>" has been successfully gone through for all procedure to the publication in "<b>Sapporo Medical Journal</b>".
                    <br>
                    <br>

                    Now you can see it and refer it for your further research. We hope you to publish with your near future.
                </p>
                <p>
                  <b>Best Regards</b>,<br>
                  Editorial Board <br>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" class="footercopy">
                ...
                <a href="https://www.maejournal.com" class="unsubscribe"><font color="#ffffff">Unsubscribe</font></a> 
