      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="bodycopy">
                <h4>Dear {{$user->prefix}} {{$user->firstname}},</h4>
                <p>
                    Thank you for your submission into "<b>Sapporo Medical Journal</b>".<br> Paper ID: "<b>{{$submit->paper_id}}</b>", Paper Title: "<b>{{$submit->ptitle}}</b>". The paper will now go through peer review process and you will be notified within 7 working days  about your submitted paper.
                </p>
                <p>
                  <b>Thank you</b>, <br>
                  Admin Board <br>
